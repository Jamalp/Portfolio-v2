  ...
  render() {
    return (
      <Layout>
        ...
        <AboutContent>
          <p>
            Jamal Powell is an independent web developer, photographer &
            creative hailing from Honolulu and currently based in Portland,
            Oregon. Motivated by a genuine curiosity in the world, Jamal thrives
            in collaborative environments that fuse cutting-edge technology with
            creative thinking and design.
          </p>
          <p>
            Jamal is passionate about partnering with agencies to deliver
            beautiful & thoughtful experiences with a close attention to detail.
            He specializes in creating elegant digital experiences that are
            engaging, responsive and interactive.
          </p>
          <p>
